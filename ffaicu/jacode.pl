...
#
# Copyright (c) 2010, 2011, 2014, 2015, 2016, 2017 INABA Hitoshi <ina@cpan.org> in a CPAN
#
...
0xfe,0xfc,
    ...
    # package jacode;
    # sub AUTOLOAD {
    #     $AUTOLOAD =~ s/^jacode::/jcode::/;
    #     goto &$AUTOLOAD;
    # }
    *jacode'init           = *jacode'init           = *jcode'init;
    *jacode'jis_inout      = *jacode'jis_inout      = *jcode'jis_inout;
    *jacode'get_inout      = *jacode'get_inout      = *jcode'get_inout;
    *jacode'getcode_utashiro_2000_09_29 =
    *jacode'getcode_utashiro_2000_09_29 =
    *jcode'getcode_utashiro_2000_09_29;
    *jacode'getcode        = *jacode'getcode        = *jcode'getcode;
    *jacode'convert        = *jacode'convert        = *jcode'convert;
    *jacode'jis            = *jacode'jis            = *jcode'jis;
    *jacode'euc            = *jacode'euc            = *jcode'euc;
    *jacode'sjis           = *jacode'sjis           = *jcode'sjis;
    *jacode'utf8           = *jacode'utf8           = *jcode'utf8;
    *jacode'to             = *jacode'to             = *jcode'to;
    *jacode'what           = *jacode'what           = *jcode'what;
    *jacode'trans          = *jacode'trans          = *jcode'trans;
    *jacode'sjis2jis       = *jacode'sjis2jis       = *jcode'sjis2jis;
    *jacode'euc2jis        = *jacode'euc2jis        = *jcode'euc2jis;
    *jacode'jis2euc        = *jacode'jis2euc        = *jcode'jis2euc;
    *jacode'jis2sjis       = *jacode'jis2sjis       = *jcode'jis2sjis;
    *jacode'sjis2euc       = *jacode'sjis2euc       = *jcode'sjis2euc;
    *jacode's2e            = *jacode's2e            = *jcode's2e;
    *jacode'euc2sjis       = *jacode'euc2sjis       = *jcode'euc2sjis;
    *jacode'e2s            = *jacode'e2s            = *jcode'e2s;
    *jacode'utf82jis       = *jacode'utf82jis       = *jcode'utf82jis;
    *jacode'utf82euc       = *jacode'utf82euc       = *jcode'utf82euc;
    *jacode'u2e            = *jacode'u2e            = *jcode'u2e;
    *jacode'utf82sjis      = *jacode'utf82sjis      = *jcode'utf82sjis;
    *jacode'u2s            = *jacode'u2s            = *jcode'u2s;
    *jacode'jis2utf8       = *jacode'jis2utf8       = *jcode'jis2utf8;
    *jacode'euc2utf8       = *jacode'euc2utf8       = *jcode'euc2utf8;
    *jacode'e2u            = *jacode'e2u            = *jcode'e2u;
    *jacode'sjis2utf8      = *jacode'sjis2utf8      = *jcode'sjis2utf8;
    *jacode's2u            = *jacode's2u            = *jcode's2u;
    *jacode'jis2jis        = *jacode'jis2jis        = *jcode'jis2jis;
    *jacode'sjis2sjis      = *jacode'sjis2sjis      = *jcode'sjis2sjis;
    *jacode'euc2euc        = *jacode'euc2euc        = *jcode'euc2euc;
    *jacode'utf82utf8      = *jacode'utf82utf8      = *jcode'utf82utf8;
    *jacode'cache          = *jacode'cache          = *jcode'cache;
    *jacode'nocache        = *jacode'nocache        = *jcode'nocache;
    *jacode'flush          = *jacode'flush          = *jcode'flush;
    *jacode'flushcache     = *jacode'flushcache     = *jcode'flushcache;
    *jacode'h2z_jis        = *jacode'h2z_jis        = *jcode'h2z_jis;
    *jacode'h2z_euc        = *jacode'h2z_euc        = *jcode'h2z_euc;
    *jacode'h2z_sjis       = *jacode'h2z_sjis       = *jcode'h2z_sjis;
    *jacode'h2z_utf8       = *jacode'h2z_utf8       = *jcode'h2z_utf8;
    *jacode'z2h_jis        = *jacode'z2h_jis        = *jcode'z2h_jis;
    *jacode'z2h_euc        = *jacode'z2h_euc        = *jcode'z2h_euc;
    *jacode'z2h_sjis       = *jacode'z2h_sjis       = *jcode'z2h_sjis;
    *jacode'z2h_utf8       = *jacode'z2h_utf8       = *jcode'z2h_utf8;
    *jacode'init_z2h_euc   = *jacode'init_z2h_euc   = *jcode'init_z2h_euc;
    *jacode'init_z2h_sjis  = *jacode'init_z2h_sjis  = *jcode'init_z2h_sjis;
    *jacode'init_z2h_utf8  = *jacode'init_z2h_utf8  = *jcode'init_z2h_utf8;
    *jacode'init_h2z_utf8  = *jacode'init_h2z_utf8  = *jcode'init_h2z_utf8;
    *jacode'init_sjis2utf8 = *jacode'init_sjis2utf8 = *jcode'init_sjis2utf8;
    *jacode'init_utf82sjis = *jacode'init_utf82sjis = *jcode'init_utf82sjis;
    *jacode'init_k2u       = *jacode'init_k2u       = *jcode'init_k2u;
    *jacode'init_u2k       = *jacode'init_u2k       = *jcode'init_u2k;
    *jacode'tr             = *jacode'tr             = *jcode'tr;
    *jacode'convf          = *jacode'convf          = *jcode'convf;
    *jacode'z2hf           = *jacode'z2hf           = *jcode'z2hf;
    *jacode'h2zf           = *jacode'h2zf           = *jcode'h2zf;
}
...
Copyright (c) 2010, 2011, 2014, 2015, 2016, 2017 INABA Hitoshi E<lt>ina@cpan.org>E<gt> in a CPAN
